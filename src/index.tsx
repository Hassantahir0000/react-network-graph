...
const data = {
  nodes: [
    { id: "AMF/UPF 1", color: "red", size: 600, x: 600, y: 10 },
    { id: "AMF/UPF 2", color: "red", size: 600, x: 900, y: 10 },
    {
    ...
    { id: "CU 1", color: "blue", size: 600, x: 600, y: 300 },
    { id: "CU 2", color: "blue", size: 600, x: 900, y: 300 },
    { id: "DU 1", x: 1000, y: 120 },
    { id: "DU 2", x: 1000, y: 190 },
    { id: "DU 3", x: 1000, y: 290 },
    { id: "DU 4", x: 1000, y: 390 },
    ...
    { id: "RU 1", color: "tomato", x: 1110, y: 90 },
    { id: "RU 2", color: "tomato", x: 1110, y: 120 },

    { id: "RU 3", color: "tomato", x: 1110, y: 190 },
    { id: "RU 4", color: "tomato", x: 1110, y: 220 },
    { id: "RU 5", color: "tomato", x: 1110, y: 150 },

    { id: "RU 6", color: "tomato", x: 1100, y: 260 },
    { id: "RU 7", color: "tomato", x: 1100, y: 290 },

    { id: "RU 8", color: "tomato", x: 1100, y: 390 },
    { id: "RU 9", color: "tomato", x: 1100, y: 410 },
    { id: "RU 10", color: "tomato", x: 1100, y: 360 },

    { id: "RU 11", color: "tomato", x: 400, y: 100 },
    { id: "RU 12", color: "tomato", x: 400, y: 140 },

    { id: "RU 13", color: "tomato", x: 400, y: 190 },
    { id: "RU 14", color: "tomato", x: 400, y: 220 },
    { id: "RU 15", color: "tomato", x: 400, y: 250 },

    { id: "RU 16", color: "tomato", x: 400, y: 290 },
    { id: "RU 17", color: "tomato", x: 400, y: 320 },

    { id: "RU 18", color: "tomato", x: 400, y: 370 },
    { id: "RU 19", color: "tomato", x: 400, y: 390 },
    { id: "RU 20", color: "tomato", x: 400, y: 420 },
  ],
  links: [
